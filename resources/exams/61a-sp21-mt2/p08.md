...
assessment: MT2
problem_number: 8
problem_title: "The Tree of L-I-F-E"
points: "7.0 points"
santai_chunk_type: "exam_problem"
---

# Problem 8 — The Tree of L-I-F-E
...
We highly encourage you to follow the skeleton. You may diverge from the skeleton if your approach is
correct and passes the doctests, but a non-working solution that doesn’t follow the skeleton will not receive
partial credit.
A correct solution should not first find all the words and then yield them; it should instead yield whenever
it finds a new word. Your solution may receive 0 points if it pre-computes the words.
Your function should use the standard CS61A Tree definition, viewable here: code.cs61a.org/tree_class
Please use code.cs61a.org to try out your code. You can then paste the code here.
def word_finder(letter_tree, words_list):
